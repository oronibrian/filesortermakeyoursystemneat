...
#A Python script that sorts files in a folder into folders
#which are named by type. It (optionally) sorts the folders created in the first sorting into categories as defined by the dictionary
